IF object_id('[dbo].[update_acbal_update]') IS NOT NULL 
EXEC ('DROP TRIGGER [dbo].[update_acbal_update]') 
GO
...
ALTER TABLE [dbo].[LedgerTrans] DISABLE TRIGGER [update_acbal_update]
GO
