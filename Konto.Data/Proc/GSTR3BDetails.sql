...
and (( a.VatTds='ECOM' and  ste.StateName = @StateName) or ( st.StateName=@StateName)) --or st.StateName like @StateName)
...
AND a.VatTds <> 'REG'
and (a.VatTds='URD' OR a.VatTds='ECOM' or a.VatTds = 'CMP' )
and (( a.VatTds='ECOM' and  ste.StateName = @StateName) or (st.StateName=@StateName))
