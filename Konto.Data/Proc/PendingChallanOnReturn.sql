IF object_id('[dbo].[PendingChallanOnReturn]') IS NULL 
EXEC ('CREATE PROC [dbo].[PendingChallanOnReturn] AS SELECT 1 AS Id') 
GO
 
ALTER PROCEDURE [dbo].[PendingChallanOnReturn]
 	@CompanyId int,
	@AccountId int,
	@ChallanTypeID int
AS
