IF object_id('[dbo].[PendingTransferOut]') IS NULL 
EXEC ('CREATE PROC [dbo].[PendingTransferOut] AS SELECT 1 AS Id') 
GO

ALTER PROCEDURE [dbo].[PendingTransferOut]
 	@CompanyId int,
	@AccountId int,
	@VoucherTypeID int,
	@ChallanType int,
...
BEGIN
	...
	--  and (c.VoucherId=@VoucherTypeID or v.RefVoucherId is null)
