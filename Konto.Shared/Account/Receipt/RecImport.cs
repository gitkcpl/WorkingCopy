...
{
    public partial class RecImport : KontoForm
    {
                        ...
                        try
                        {
                            foreach (System.Data.DataRow dr in _dataTable.Rows)
                            {
                              ...
                              //  bill.VDate = Convert.ToDateTime(dr["Date"].ToString());
                                ...
                                bill.TypeId = (int)VoucherTypeEnum.ReceiptVoucher;
                                ...
                                var vchr = db.Vouchers.FirstOrDefault(k => k.VTypeId == (int)VoucherTypeEnum.ReceiptVoucher);
                                ...
                                bill.VoucherDate = bill.VoucherDate = Convert.ToInt32(dr["Date"]); //Convert.ToInt32(bill.VDate.ToString("yyyyMMdd"));
                            ...
                            foreach (var b in BillList)
                            {
                                ...
                                db.SaveChanges();
                                LedgerEff.BillRefEntrypayrec("Credit", b, btrans, new List<Data.Models.Transaction.Dtos.BankTransDto>(), db);
                                //Insert or update in LedgerTrans table
                                LedgerEff.LedgerTransEntryRecPay("Credit", b, db, btrans, new List<Data.Models.Transaction.Dtos.PendBillListDto>());
                            }
