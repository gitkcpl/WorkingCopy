...
{
    public partial class PInvoiceIndex : KontoMetroForm
    {
        ...
        public PInvoiceIndex()
        {
            ...
            this.MainLayoutFile = KontoFileLayout.Purchase_Index;
            this.GridLayoutFile = KontoFileLayout.Purchase_Trans;
        ...
        private void SetGridColumn()
        {
            ...
            colBarcode.Visible = PurchasePara.Barcode_Required;
            colOtherAdd.Visible = PurchasePara.OtherAdd_Required;
            colOtherLess.Visible = PurchasePara.OtherLess_Required;
            colCess.Visible = PurchasePara.Cess_Required;
            colCessPer.Visible = PurchasePara.Cess_Required;

            if (PurchasePara.Barcode_Required)
            {
        ...
        private bool ValidateData()
        {
            ...
            using (var db = new KontoContext())
            {
               ...
               && x.TypeId ==(int)VoucherTypeEnum.PurchaseInvoice);
            ...
            using (var _context = new KontoContext())
            {
                ...
                var _lst = (from bt in _context.BillTrans
                            ...
                            select new BillTransDto
                            {
                                ...
                                RefTransId= bt.RefTransId,RefVoucherId=bt.RefVoucherId,SaleRate=bt.SaleRate, RatePerQty=p.Price2,
                                Barcode= p.BarCode
                            }
                             ).ToList();
        ...
        private void TabControlAdv1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                var _list = tabPageAdv2.Controls[0] as PInvoiceListView;
            ...
            {
                var _ListView = new PInvoiceListView();
            ...
            if (tabControlAdv1.SelectedIndex == 2)
            {
                ...
                var _frm = new AnalysisUserControl(VoucherTypeEnum.PurchaseInvoice, true);
