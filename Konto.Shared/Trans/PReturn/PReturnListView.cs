...
{
    public partial class PReturnListView : ListBaseView
    {
        //private List<OpBillListDto> _modelList = new List<OpBillListDto>();

        public PReturnListView()
        ...
        public override void DeleteRec()
        {
            ...
            using (var db = new KontoContext())
            {
                using (var _tran = db.Database.BeginTransaction())
                {
                    ...
                    {
                        _tran.Rollback();
                        Log.Error(ex, "Purchase Return delete");
        ...
        public override void Print()
        {
            ...
            if (KontoView.Columns.ColumnByFieldName("Id") != null)
            {
                ...
                var frm = new DocPrintParaView(VoucherTypeEnum.PurchaseReturn, "Purchase Return Print", id, id, "PURRET", "BillId");
