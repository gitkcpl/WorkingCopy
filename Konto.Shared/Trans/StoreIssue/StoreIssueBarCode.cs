...
{
    public partial class StoreIssueBarCode : KontoForm
    {
        ...
        public StoreIssueBarCode()
        {
            InitializeComponent();
            this.Shown += StoreIssueBarCode_Shown;

            this.ChangeQtysimpleButton.Click += ChangeQtysimpleButton_Click;
        ...
        private void StoreIssueBarCode_Shown(object sender, EventArgs e)
        {
        ...
        {
            if (StoreIssuePara.Store_Issue_Against_Order)
            {
                var _trans = this.bindingSource1.DataSource as List<JobIssueBarcodeDto>;
