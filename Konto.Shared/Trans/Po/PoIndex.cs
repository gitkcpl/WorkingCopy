...
namespace Konto.Shared.Trans.Po
{
    public partial class PoIndex : KontoMetroForm
    {
        ...
        public PoIndex()
        {
            ...
            this.MainLayoutFile = KontoFileLayout.Po_Index;
            this.GridLayoutFile = KontoFileLayout.Po_Trans;
        ...
        private void GridView1_ShowingEditor(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            if (itm == null)
                return;
            if(PoPara.Default_Order_Status == "PENDING" && itm.OrdStatus != "PENDING")
            {
                e.Cancel = true;
            }
        }
        ...
        {
            colColorName.Visible = PoPara.Color_Required;
            colDesignNo.Visible = PoPara.Design_Required;
            colGradeName.Visible = PoPara.Grade_Required;
            colNoOfLot.Visible = PoPara.Grey_Details_Textiles_Required;
        ...
        private void SetParameter()
        {
            using (var db = new KontoContext())
            {
                var _paralists = db.CompParas.Include("SysPara")
                              .Where(x => x.SysPara.Category == "Purchase Order" && x.CompId == KontoGlobals.CompanyId)
                             .ToList();
                ...
                foreach (var item in _paralists)
                {
                    ...
                    switch (item.ParaId)
                    {
                        case 25: //PO
                            {
                                PoPara.Color_Required = (value == "Y") ? true : false;
                                break;
                            }
                        case 26:
                            {
                                PoPara.Design_Required = (value == "Y") ? true : false;
                                break;
                            }
                        case 27:
                            {
                                PoPara.Grade_Required = (value == "Y") ? true : false;
                                break;
                            }
                        case 28:
                            {
                                PoPara.Grey_Details_Textiles_Required = (value == "Y") ? true : false;
                                break;
                            }
                        case 29:

                            {
                                PoPara.Checker_In_Required = (value == "Y") ? true : false;
                                break;
                            }
                        case 30:
                            {
                                PoPara.Checker_Out_Required = (value == "Y") ? true : false;
                                break;
                            }
                        case 31:
                            {
                                PoPara.Default_Order_Status = value;
                                break;
                            }
                        case 57:
                            {
        ...
        private void LoadData(OrdDto model)
        {
            ...
            this.Text = "Purchase Order [View/Modify]";
        ...
        private void GridView1_InitNewRow(object sender, DevExpress.XtraGrid.Views.Grid.InitNewRowEventArgs e)
        {
            ...
            //   // rw.Cut = 1200;
            //}
            rw.OrdStatus = PoPara.Default_Order_Status;
        }
        ...
        private void TabControlAdv1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                var _list = tabPageAdv2.Controls[0] as PoListView;
                _list.ActiveControl = _list.KontoGrid;
                return;
            }
            if (tabControlAdv1.SelectedIndex == 1)
            {
                var _ListView = new PoListView();
        ...
        private void PoIndex_Load(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                Log.Error(ex, "Purchase Order Load");
        ...
        public override void NewRec()
        {
            ...
            this.Text = "Purchase Order [Add New]";
        ...
        public override void SaveDataAsync(bool newmode)
        {
            ...
            model.TypeId = (int)VoucherTypeEnum.PurchaseOrder;
