...
{
    public partial class SizeLkpWindow : LookupForm
    {
        List<SizeLookupDto> _modelList = new List<SizeLookupDto>();
        public SizeLkpWindow()
        {
            InitializeComponent();
          
            this.GridLayoutFileName = KontoFileLayout.Size_Lookup_Layout;
            this.FormClassName = "Konto.Shared.Masters.Size.SizeIndex";
        ...
        public override void LoadData()
        {
            ...
            {
                _modelList = (from ar in _db.SizeModels
                              where (!ar.IsDeleted && ar.IsActive)
                              orderby ar.SizeName
                              select new SizeLookupDto
                              {
                                  DisplayText = ar.SizeName,
                                  Id = ar.Id,
                              }
                             ).ToList();
            }
