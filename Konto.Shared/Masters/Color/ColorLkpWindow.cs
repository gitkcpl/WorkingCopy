...
{
    public partial class ColorLkpWindow : LookupForm
    {
        List<ColorLookupDto> _modelList = new List<ColorLookupDto>();
        public ColorLkpWindow()
        {
            InitializeComponent();
          
            this.GridLayoutFileName = KontoFileLayout.Color_Lookup_Layout;
            this.FormClassName = "Konto.Shared.Masters.Color.ColorIndex";
        ...
        public override void LoadData()
        {
            ...
            {
                _modelList = (from ar in _db.ColorModels
                              where (!ar.IsDeleted && ar.IsActive)
                              orderby ar.ColorName
                              select new ColorLookupDto
                              {
                                  DisplayText = ar.ColorName,
                                  Id = ar.Id,
                              }
                             ).ToList();
            }
