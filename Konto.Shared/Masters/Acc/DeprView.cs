...
{
    public partial class DeprView : KontoForm
    {
        ...
        private void OkSimpleButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using(var db = new KontoContext())
                {
                    ...
                    model.DepAccId = Convert.ToInt32(accLookup1.SelectedValue);
                    model.DepPer = perNumericUpDown.Value;
        ...
        private void DeprView_Load(object sender, EventArgs e)
        {
            using(var db = new KontoContext())
            {
                ...
                if (model != null)
                {
                    accLookup1.SelectedValue = model.DepAccId;
                    accLookup1.SetAcc(Convert.ToInt32(model.DepAccId));
                    perNumericUpDown.Value = Convert.ToDecimal(model.DepPer);
                }
            }
        }
    }
