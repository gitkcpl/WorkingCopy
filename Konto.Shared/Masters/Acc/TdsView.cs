...
{
    public partial class TdsView : KontoForm
    {
        ...
        private void OkSimpleButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using(var db = new KontoContext())
                {
                    ...
                    model.TdsAccId = Convert.ToInt32(accLookup1.SelectedValue);
        ...
        private void DeprView_Load(object sender, EventArgs e)
        {
            using(var db = new KontoContext())
            {
                ...
                if (model != null)
                {
                    accLookup1.SelectedValue = model.TdsAccId;
                    accLookup1.SetAcc(Convert.ToInt32(model.TdsAccId));
