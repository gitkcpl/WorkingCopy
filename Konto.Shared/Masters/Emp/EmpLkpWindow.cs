...
{
    public partial class EmpLkpWindow : LookupForm
    {
        List<EmpLookupDto> _modelList = new List<EmpLookupDto>();
        public EmpLkpWindow()
        {
            InitializeComponent();
            this.GridLayoutFileName = KontoFileLayout.Emp_Lookup_List_Layout;
            this.FormClassName = "Konto.Shared.Masters.Emp.EmpIndex";
        ...
        public override void LoadData()
        {
            ...
            {
                _modelList = (from ar in _db.Emps
                              where (!ar.IsDeleted && ar.IsActive)
                              orderby ar.EmpName
                              select new EmpLookupDto
                              {
                                  DisplayText = ar.EmpName,
                                  Id = ar.Id,
                              }
                             ).ToList();
            }
