...
{
    public partial class ScreenListView : ListBaseView
    {
        ...
        public override void RefreshGrid()
        {
            try
            {
                ...
                {
                    _modelList = _db.Hastes.Where(x => !x.IsDeleted && x.MType=="Screen")
            ...
            catch (Exception ex)
            {
                ...
                Log.Error(ex, "screen refresh Grid");
        ...
        public override void DeleteRec()
        {
            ...
            catch (Exception ex)
            {
                ...
                Log.Error(ex, "screen Master delete");
                MessageBoxAdv.Show(this, "Error While Delete !!", "Exception ", ex.ToString());
            }
        }
    }
