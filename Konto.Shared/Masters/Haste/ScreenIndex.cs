...
{
    public partial class ScreenIndex : KontoMetroForm
    {
        ...
        private void OkSimpleButton_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                Log.Error(ex, "Screen Master Save");
        ...
        private bool ValidateData()
        {
            ...
            using (var db = new KontoContext())
            {
                ...
                if (find != null)
                {
                    MessageBoxAdv.Show(this, "Screen Name Already Exists", "Duplicate Data", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    nameTextBox.Focus();
                    return false;
                }
            }
        ...
        public override void NewRec()
        {
            ...
            this.Text = "Screen Master [Add New]";
        ...
        private void LoadData(HasteModel model)
        {
            ...
            nameTextBox.Focus();
            this.Text = "Screen Master [View/Modify]";
        }
        ...
        public override void FindRec()
        {
           ...
           // EmpModel _find = new EmpModel();
            ...
            filter.Add(new Filter { PropertyName = "MType", Operation = Op.Equals, Value = "Screen" });
