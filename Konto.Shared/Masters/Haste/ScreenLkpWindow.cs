...
{
    public partial class ScreenLkpWindow : LookupForm
    {
        public string MType { get; set; }
        List<HasteLookupDto> _modelList = new List<HasteLookupDto>();
        public ScreenLkpWindow()
        {
            InitializeComponent();
            this.GridLayoutFileName = KontoFileLayout.Haste_Lookup_List_Layout;
            this.FormClassName = "Konto.Shared.Masters.Haste.ScreenIndex";
        ...
        public override void LoadData()
        {
            ...
            using (var _db = new KontoContext())
            {
                _modelList = (from ar in _db.Hastes
                              where (!ar.IsDeleted && ar.IsActive && ar.MType=="Screen")
