...
{
    public partial class BrandLkpWindow : LookupForm
    {
        List<BrandLookupDto> _modelList = new List<BrandLookupDto>();
        public BrandLkpWindow()
        {
            InitializeComponent();
          
            this.GridLayoutFileName = KontoFileLayout.Brand_Lookup_Layout;
            this.FormClassName = "Konto.Shared.Masters.Brand.BrandIndex";
        ...
        public override void LoadData()
        {
            ...
            {
                _modelList = (from ar in _db.Brands
                              where (!ar.IsDeleted && ar.IsActive)
                              orderby ar.BrandName
                              select new BrandLookupDto
                              {
                                  DisplayText = ar.BrandName,
                                  Id = ar.Id,
                              }
                             ).ToList();
            }
