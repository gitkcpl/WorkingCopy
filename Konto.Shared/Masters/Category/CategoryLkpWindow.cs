...
{
    public partial class CategoryLkpWindow : LookupForm
    {
        List<CategoryLookupDto> _modelList = new List<CategoryLookupDto>();
        public CategoryLkpWindow()
        {
            InitializeComponent();
          
            this.GridLayoutFileName = KontoFileLayout.Category_Lookup_Layout;
            this.FormClassName = "Konto.Shared.Masters.Category.CategoryIndex";
        ...
        public override void LoadData()
        {
            ...
            {
                _modelList = (from ar in _db.CategroyModels
                              where (!ar.IsDeleted && ar.IsActive)
                              orderby ar.CatName
                              select new CategoryLookupDto
                              {
                                  DisplayText = ar.CatName,
                                  Id = ar.Id,
                              }
                             ).ToList();
            }
