...
{
    public partial class DesignLookup : LookupBase
    {
            ...
            using (var _context = new KontoContext())
            {
                ...
                if (model != null)
                {
                    ...
                    (from pd in _context.Products
                     ...
                     !pd.IsDeleted && pd.ItemType == "D" && pd.Id == model.Id
                    ...
                    this.SelectedText = model.ProductCode;
                    buttonEdit1.Text = model.ProductCode;
                }
            }
        }
        ...
        private void ShowList()
        {
            ...
            if (frm.DialogResult == DialogResult.OK)
            {
                ...
                this.SelectedText = GroupDto.ProductCode;
