...
{
    public partial class DivListView : ListBaseView
    {
        private List<DivListDto> _modelList = new List<DivListDto>();
        public DivListView()
        {
            InitializeComponent();
        ...
        public override void RefreshGrid()
        {
            ...
            {
                _modelList = _db.Divisions.Where(x => !x.IsDeleted && x.BranchId == KontoGlobals.BranchId)
                            .ProjectToList<DivListDto>(configuration);
        ...
        public override void DeleteRec()
        {
            ...
            try
            {
                ...
                {
                    var model = db.Divisions.Find(_id);
