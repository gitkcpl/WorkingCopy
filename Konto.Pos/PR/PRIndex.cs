...
namespace Konto.Pos.PR
{
    public partial class PRIndex : KontoMetroForm
    {
        ...
        public PRIndex()
        {
            ...
            this.MainLayoutFile = KontoFileLayout.Pos_Purchase_Return_Index;
            this.GridLayoutFile = KontoFileLayout.Pos_Purchase_Return_Trans;
        ...
        private void BillNoTextEdit_ButtonClick(object sender, ButtonPressedEventArgs e)
        {
            ...
            {
                var ac = Convert.ToInt32(accLookup1.SelectedValue);
                ...
                var _lst = (from bt in _context.BillTrans
                            ...
                            orderby bt.Id
                            where bm.BillNo == billNoTextEdit.Text && bm.AccId== ac && !bt.IsDeleted && !bm.IsDeleted && bm.IsActive
                            select new BillTransDto
                            {
                               ...
                               // BillId = bt.BillId,
                                ...
                                HsnCode = p.HsnCode,
                                Barcode = p.BarCode,ChDate = bm.VoucherDate
                            }
                   ).ToList();
        ...
        private void SetGridColumn()
        {
            ...
            colFreight.Visible = PosPrPara.Freight_Required;
            colFreightRate.Visible = PosPrPara.Freight_Required;
            colCut.Visible = PosPrPara.Cut_Required;
            colHsnCode.Visible = PosPrPara.HsnCode_Required;
            colCess.Visible = PosPrPara.Cess_Required;
            colCessPer.Visible = PosPrPara.Cess_Required;
            colOtherAdd.Visible = PosPrPara.OtherAdd_Required;
            colOtherLess.Visible = PosPrPara.OtherLess_Required;
            ...
            repo1.Mask.EditMask = "n" + PosPrPara.Rate_Decimal.ToString();
            colRate.ColumnEdit = repo1;
            colRate.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
            colRate.DisplayFormat.FormatString = "n" + PosPrPara.Rate_Decimal.ToString();

            //Qty Decimal Settings
            repositoryItemTextEdit1.Mask.EditMask = "n" + PosPrPara.Qty_Decimal.ToString();
            colQty.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
            colQty.DisplayFormat.FormatString = "n" + PosPrPara.Qty_Decimal.ToString();
        }
        ...
        private void SetParameter()
        {
            using (var db = new KontoContext())
            {
                var _paralists = db.CompParas.Include("SysPara")
                              .Where(x => x.SysPara.Category == "Pos_Pr" && x.CompId == KontoGlobals.CompanyId)
                             .ToList();
                ...
                foreach (var item in _paralists)
                {
                    ...
                    switch (item.ParaId)
                    {
                        ...
                        case 269:
                            {
                                PosPrPara.Cut_Required = (value == "Y") ? true : false;
                                break;
                            }
                        case 270:
                            {
                                PosPrPara.Freight_Required = (value == "Y") ? true : false;
                                break;
                            }
                        case 271:
                            {
                                PosPrPara.OtherAdd_Required = (value == "Y") ? true : false;
                                break;
                            }
                        case 272:
                            {
                                PosPrPara.OtherLess_Required = (value == "Y") ? true : false;
                                break;
                            }

                        case 273:
                            {
                                PosPrPara.Cess_Required = (value == "Y") ? true : false;
                                break;
                            }

                        case 274:
                            {
                                PosPrPara.Tax_RoundOff = (value == "Y") ? true : false;
                                break;
                            }

                        case 275:
                            {
                                PosPrPara.Ask_For_Voucher_Selection = (value == "Y") ? true : false;
                                break;
                            }

                        case 276:
                            {
                                PosPrPara.HsnCode_Required = (value == "Y") ? true : false;
                                break;
                            }
                        ...
                        case 277:
                            {
                                ...
                                if (!string.IsNullOrEmpty(value) && Convert.ToInt32(value) >= 2 && Convert.ToInt32(value) <= 4)
                                    PosPrPara.Rate_Decimal = Convert.ToInt32(value);
                                break;
                            }
                        case 278:
                            {
                                ...
                                if (!string.IsNullOrEmpty(value) && Convert.ToInt32(value) >= 2 && Convert.ToInt32(value) <= 3)
                                    PosPrPara.Qty_Decimal = Convert.ToInt32(value);
                                break;
                            }
                        case 279:
                            {
                                PosPrPara.Validate_Barcode_Party = (value == "Y") ? true : false;
                                break;
                            }
        ...
        private void GridView1_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            ...
            if (e.Column.FieldName == "Barcode" && e.Value != null && !string.IsNullOrEmpty(e.Value.ToString()))
            {
                ...
                if (PosPrPara.Validate_Barcode_Party) // check for barcode belong to party
                {
                    using(var db = new KontoContext())
                    {
                        ...
                        var frm = (from p in db.Bills
                                   ...
                                   where p.AccId ==acid && pd.BarCode == e.Value.ToString()
                                   select p
                                   ).FirstOrDefault();
        ...
        private void billSimpleButton_Click(object sender, EventArgs e)
        {
            string type = "CREDIT";
