...
{
    public partial class SRIndex : KontoMetroForm
    {
        ...
        public SRIndex()
        {
            ...
            this.MainLayoutFile = KontoFileLayout.Pos_Sales_Return_Index;
            this.GridLayoutFile = KontoFileLayout.Pos_Sales_Return_Trans;
            ...
            extra2TextEdit.KeyDown += Extra2TextEdit_KeyDown; // get customer details from mobile no
            extra2TextEdit.Enter += Extra2TextEdit_Enter;
            billNoTextEdit.KeyDown += BillNoTextEdit_KeyDown;
        }

        private void BillNoTextEdit_KeyDown(object sender, KeyEventArgs e)
        {
            if (this.PrimaryKey != 0 || e.KeyCode != Keys.Enter) return;
            ...
            using (var _context = new KontoContext())
            {
                ...
                var _lst = (from bt in _context.BillTrans
                            join bm in _context.Bills on bt.BillId equals bm.Id
                            ...
                            join e2 in _context.Emps on bt.RefBankId equals e2.Id into join_e
                            from em in join_e.DefaultIfEmpty()
                            join pr in _context.Prices on p.Id equals pr.ProductId
                            orderby bt.Id
                            where bm.VoucherNo== billNoTextEdit.Text.Trim() && !bt.IsDeleted && bt.IsActive
                            && bm.Extra2 == extra2TextEdit.Text.Trim()
                            select new BillTransDto
                            {
                              ...
                              //  ChallanNo = chl.VoucherNo,
                               ...
                               // OrdId = or.Id,
                                ...
                                RefId = bt.BillId,
                                RefTransId = bt.Id,
                                RefVoucherId = bm.VoucherId,
                                SaleRate = bt.SaleRate,
                                HsnCode = p.HsnCode,
                                Barcode = p.BarCode,
                                ChkNegative = p.CheckNegative,
                                EmpId = bt.RefBankId != null ? (int)bt.RefBankId : 0,
                                ItemStatus = bt.RpType,
                                CostRate = pr.DealerPrice,
                                Mrp = pr.Mrp,
                                RatePerQty = p.Price2,
                                Salesman = em.EmpName
                ...
                if(_lst.Count == 0)
                {
                    MessageBox.Show("Bill No or Mobile No does not match");
                    return;
                }

                billDateEdit.EditValue = _lst[0].ChallanDate;
        ...
        private void Extra2TextEdit_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (extra2TextEdit.Text == "0000000000") return;
            ...
            using (var db = new KontoContext())
            {
                ...
                if (cust != null)
                {
                    ...
                    customerTextEdit.Text = cust.AccName;
                    e.Handled = true;
                    empLookup1.Focus();
                }
                else
                {
                    ...
                    if (cst != null)
                    {
                        ...
                        customerTextEdit.Text = cst.CustomerName;
        ...
        private void SetGridColumn()
        {
            ...
            colFreight.Visible = PosRetPara.Freight_Required;
            colFreightRate.Visible = PosRetPara.Freight_Required;
            colCut.Visible = PosRetPara.Cut_Required;
            colHsnCode.Visible = PosRetPara.HsnCode_Required;
            colPcs.Visible = PosRetPara.Pcs_Required;
            colOtherAdd.Visible = PosRetPara.OtherAdd_Required;
            colOtherLess.Visible = PosRetPara.OtherLess_Required;
            colRate.Visible = PosRetPara.Rate_Required;


            colCgst.Visible = PosRetPara.Tax_Required;
            colCgstPer.Visible = PosRetPara.Tax_Required;
            colSgstPer.Visible = PosRetPara.Tax_Required;
            colSgst.Visible = PosRetPara.Tax_Required;
            colIgstPer.Visible = PosRetPara.Tax_Required;
            colIgst.Visible = PosRetPara.Tax_Required;
            colCess.Visible = PosRetPara.Cess_Required;
            colCessPer.Visible = PosRetPara.Cess_Required;

            colCgst.OptionsColumn.AllowFocus = PosRetPara.Tax_Editable;
            colCgstPer.OptionsColumn.AllowFocus = PosRetPara.Tax_Editable;
            colSgstPer.OptionsColumn.AllowFocus = PosRetPara.Tax_Editable;
            colSgst.OptionsColumn.AllowFocus = PosRetPara.Tax_Editable;
            colIgstPer.OptionsColumn.AllowFocus = PosRetPara.Tax_Editable;
            colIgst.OptionsColumn.AllowFocus = PosRetPara.Tax_Editable;
            colCess.OptionsColumn.AllowFocus = PosRetPara.Tax_Editable;
            colCessPer.OptionsColumn.AllowFocus = PosRetPara.Tax_Editable;
            ...
            using (var db = new KontoContext())
            {
                ...
                foreach (var item in _paralists)
                {
                    ...
                    switch (item.ParaId)
                    {
                        ...
                        case 280:
                            {
                                PosRetPara.Cut_Required = (value == "Y") ? true : false;
                                break;
                            }
                        case 281:
                            {
                                PosRetPara.Freight_Required = (value == "Y") ? true : false;
                                break;
                            }
                        case 282:
                            {
                                PosRetPara.OtherAdd_Required = (value == "Y") ? true : false;
                                break;
                            }
                        case 283:
                            {
                                PosRetPara.OtherLess_Required = (value == "Y") ? true : false;
                                break;
                            }

                        case 284:
                            {
                                PosRetPara.Cess_Required = (value == "Y") ? true : false;
                                break;
                            }
                        case 285:
                            {
                                PosRetPara.Tax_RoundOff = (value == "Y") ? true : false;
                                break;
                            }
                        case 286:
                            {
                        ...
                        case 287:
                            {
                                PosRetPara.HsnCode_Required = (value == "Y") ? true : false;
                                break;
                            }
                        case 288:
                            {
                                ...
                                if (!string.IsNullOrEmpty(value) && Convert.ToInt32(value) >= 2 && Convert.ToInt32(value) <= 4)
                                    PosRetPara.Rate_Decimal = Convert.ToInt32(value);
                                break;
                            }
                        case 289:
                            {
                                ...
                                if (!string.IsNullOrEmpty(value) && Convert.ToInt32(value) >= 2 && Convert.ToInt32(value) <= 3)
                                    PosRetPara.Qty_Decimal = Convert.ToInt32(value);
                                break;
                            }
                        case 290:
                            {
                                PosRetPara.Pcs_Required = (value == "Y") ? true : false;
                                break;
                            }
                        case 291:
                            {
                                PosRetPara.Merge_Qty_For_Same_Barcode = (value == "Y") ? true : false;
                                break;
                            }
                        case 292:
                            {
                                PosRetPara.Move_Next_Barcode = (value == "Y") ? true : false;
                                break;
                            }
                        case 293:
                            {
                                PosRetPara.Rate_Required = (value == "Y") ? true : false;
                                break;
                            }
                        case 294:
                            {
                                PosRetPara.Tax_Required = (value == "Y") ? true : false;
                                break;
                            }
                        case 295:
                            {
                                PosRetPara.Tax_Editable = (value == "Y") ? true : false;
                                break;
                            }
        ...
        private bool ValidateData()
        {
            ...
            else if (stateLookUpEdit.EditValue== null || stateLookUpEdit.EditValue== DBNull.Value)
            {
        ...
        private void LoadData(BillModel model)
        {
            ...
            using (var _context = new KontoContext())
            {
                ...
                if (!string.IsNullOrEmpty(model.Extra2))
                {
                    ...
                    if (cust != null)
                    {
                        customerTextEdit.Text = cust.CustomerName;
                        gstInTextEdit.Text = cust.GstNo;
                        addressTextEdit.Text = cust.Address;
                    }
                }
        ...
        private void GridView1_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            ...
            if(e.Column.FieldName == "Barcode" && e.Value != null && !string.IsNullOrEmpty(e.Value.ToString()))
            {
                ...
                using (var db = new KontoContext())
                {
                    var acid = Convert.ToInt32(accLookup1.SelectedValue);
                    ...
                    if (frm == null)
                    {
                        MessageBox.Show("Barcode Not Belong to selected party..");
        ...
        private void AccLookup1_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            {
                stateLookUpEdit.EditValue = this.accLookup1.LookupDto.StateId;

                gstInTextEdit.Text = this.accLookup1.LookupDto.GSTIN;
                customerTextEdit.Text = this.accLookup1.LookupDto.AccName;
        ...
        private void TabControlAdv1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                var _list = tabPageAdv2.Controls[0] as SRListView;
            ...
            using (var db = new KontoContext())
            {
                using (var _tran = db.Database.BeginTransaction())
                {
                    try
                    {
                        ...
                        var tr = _translist.FirstOrDefault();
                        var br = db.BillRefs.SingleOrDefault(x => x.BillId == tr.RefId && x.BillVoucherId == tr.RefVoucherId);

                        if(br.BillAmt < billAmtSpinEdit.Value)
                        {
                            MessageBox.Show("Return Amount can not be greater than Invoice Amount");
                            _tran.Rollback();
                            return;
                        ...
                        var pld = new PendBillListDto()
                        {

                            BillNo = _find.BillNo,
                            Amount = _find.TotalAmount,
                            RefCode = br.RowId,
                            BillId = tr.RefId,
                            BillVoucherId = tr.RefVoucherId,
                            BillTransId = tr.RefId,
                        };

                        this.BillList.Add(pld);
