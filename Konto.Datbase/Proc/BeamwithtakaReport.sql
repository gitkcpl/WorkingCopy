CREATE PROCEDURE [dbo].[BeamwithtakaReport]
	@CompanyId int=1,
	@VoucherID int=0,
	@FromDate int=0,
	@ToDate int=0,
...
,p.Ply as BLength,p.CopsWt,p.CartnWt,p.GrossWt,p.TareWt
	  ...
	  tb.MachineName as MachineNo,tb.TakaQty as TakaProd,p.NetWt-isnull(tb.TakaQty,0) as BalQty,(p.Ply-isnull(tb.TakaMtr,0))/p.Ply*100 as balper,0 as beamdays
