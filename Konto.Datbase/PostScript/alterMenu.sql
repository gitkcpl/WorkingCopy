...
update dbo.ErpModule set moduledesc= 'Mill Receipt Challan' where id=356 -- mill receipt challan

update dbo.ErpModule set moduledesc= 'Job Receipt Challan' where id=319 -- job receipt challan
