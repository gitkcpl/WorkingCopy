...
(
   Id,AccName,PrintName,GroupId,PGroupId, IsActive, IsDeleted,CreateDate,CreateUser,
   RowId,TdsReq,TcsReq,VatTds,IoTax,DeducteeId,NopId,CrDays,CrLimit,BToB,AgentId,TransportId,EmpId,AddressId
)values (2,'SALES A/C (GST)','SALES A/C (GST)',9,1,1,0,GetDate(),'Admin',NEWID(),'NO','NO','GST','NA',1,1,0,0,'NO',1,1,1,0)
...
(
   Id,AccName,PrintName,GroupId,PGroupId, IsActive, IsDeleted,CreateDate,CreateUser,
   RowId,TdsReq,TcsReq,VatTds,IoTax,DeducteeId,NopId,CrDays,CrLimit,BToB,AgentId,TransportId,EmpId,AddressId
)values (7,'PURCHASE A/C (GST)','PURCHASE A/C (GST)',10,1,1,0,GetDate(),'Admin',NEWID(),'NO','NO','GST','NA',1,1,0,0,'NO',1,1,1,0)
...
(
   Id,AccName,PrintName,GroupId,PGroupId, IsActive, IsDeleted,CreateDate,CreateUser,
   RowId,TdsReq,TcsReq,VatTds,IoTax,DeducteeId,NopId,CrDays,CrLimit,BToB,AgentId,TransportId,EmpId,AddressId
)values (8,'PURCHASE A/C (IGST)','PURCHASE A/C (IGST)',10,1,1,0,GetDate(),'Admin',NEWID(),'NO','NO','IGST.','NA',1,1,0,0,'NO',1,1,1,0)
...
(
   Id,AccName,PrintName,GroupId,PGroupId, IsActive, IsDeleted,CreateDate,CreateUser,
   RowId,TdsReq,TcsReq,VatTds,IoTax,DeducteeId,NopId,CrDays,CrLimit,BToB,AgentId,TransportId,EmpId,AddressId
)values (36,'Process Accounts ','Process Accounts ',29,1,1,0,GetDate(),'Admin',NEWID(),'NO','NO','NA','NA',1,1,0,0,'NO',1,1,1,0)
