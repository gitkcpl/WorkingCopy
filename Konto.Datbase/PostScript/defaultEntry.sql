...
(
   ...
   RowId
)values (1, 1,GETDATE(),'Allows system administration of Users/Roles/Permissions','System Administrator',NEWID())
END
...
(
   Id,IsSysAdmin,CreateDate,RoleDescription,RoleName,
   RowId
)values (2, 0,GETDATE(),'Default role with limited permissions','Default User',NEWID())
END
...
BEGIN
	INSERT INTO UserMaster(Id,CreateDate,EmpId,IsActive,RoleId,RowId,UserName,UserPass)
	values(1,GETDATE(),1,1,1,NEWID(),'KEYSOFT','N8WqBhvsRTrv7C71OZxNXQ==')
END
...
BEGIN
	INSERT INTO UserMaster(Id,CreateDate,EmpId,IsActive,RoleId,RowId,UserName,UserPass)
	values(2,GETDATE(),1,1,1,NEWID(),'Admin','iqdT6mfVNJs=')
END
...
INSERT INTO dbo.Product(Id,RowId,ProductName,ProductCode,BarCode,HsnCode,PurTaxId,
...
DealerPrice,IpAddress,IssueQty,Mrp,Qty,RowId,SaleRate)
