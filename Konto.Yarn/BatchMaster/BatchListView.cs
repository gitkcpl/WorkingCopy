...
{
    public partial class BatchListView : ListBaseView
    {
       // private List<BatchDTO> _modelList = new List<BatchDTO>();
        public BatchListView()
        {
            InitializeComponent();
            this.GridLayoutFileName = KontoFileLayout.Batch_List;
            ...
            try
            {
                ...
                using (var con = new SqlConnection(db.Database.Connection.ConnectionString))
                {
                    using (var cmd = new SqlCommand(listDateRange1.SelectedItem.SpName, con))
                    {
                        ...
                        cmd.Parameters.Add("@VTypeId", SqlDbType.Int).Value = (int)VoucherTypeEnum.Batch;
        ...
        public override void DeleteRec()
        {
            ...
            try
            {
                ...
                using (var db = new KontoContext())
                {
                    ...
                    var trans = db.jobCardTrans.Where(k => k.JobCardId == _id).ToList();
