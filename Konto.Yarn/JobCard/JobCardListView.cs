...
{
    public partial class JobCardListView : ListBaseView
    {
       // private List<BatchDTO> _modelList = new List<BatchDTO>();
        public JobCardListView()
        {
            InitializeComponent();
            this.GridLayoutFileName = KontoFileLayout.YarnJobCard_List;
        ...
        public override void DeleteRec()
        {
            ...
            catch (Exception ex)
            {
                ...
                Log.Error(ex, "Yarn JobCard  delete");
