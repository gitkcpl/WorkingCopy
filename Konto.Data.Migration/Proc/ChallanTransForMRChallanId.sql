IF object_id('[dbo].[ChallanTransForMRChallanId]') IS NULL 
EXEC ('CREATE PROC [dbo].[ChallanTransForMRChallanId] AS SELECT 1 AS Id') 
GO

ALTER PROCEDURE [dbo].[ChallanTransForMRChallanId]
	@id INT = 0
AS
BEGIN
    SELECT ct.ChallanId,
