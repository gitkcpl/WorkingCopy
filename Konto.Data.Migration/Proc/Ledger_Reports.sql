IF object_id('[dbo].[Ledger_Reports]') IS NULL 
...
(
    ...
    (
        ...
        SELECT 1 AS flag,
               ...
               l.Debit DebitAmt,
               l.Credit CreditAmt,
               CASE WHEN v.VTypeId = 12  THEN l.VoucherNo else l.BillNo END AS VoucherNo,
               ISNULL(l.BillNo, l.VoucherNo) AS BillNo,
               l.VoucherDate,
              CASE WHEN ISNULL(bm.Rcm,'X')='Yes' THEN  v.VoucherName + '-RCM' ELSE v.VoucherName END Voucher,
