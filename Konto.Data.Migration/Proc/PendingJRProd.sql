...
begin
    ...
    c.VoucherDate ChlnDate,ISNULL(np.ProductName,p.ProductName) as Product,col.ColorName as Color,
	...
	0.00 Pcs,	
	isnull(ct.Qty,0.00) as IssueQty,
	CAST(ISNULL(ct.Pcs,0.00) AS NUMERIC(18,2)) as IssuePcs,
