IF object_id('[dbo].[TrialBalanceReport]') IS NULL 
EXEC ('CREATE PROC [dbo].[TrialBalanceReport] AS SELECT 1 AS Id') 
GO

ALTER PROCEDURE [dbo].[TrialBalanceReport]
(
