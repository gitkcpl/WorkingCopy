...
SET IDENTITY_INSERT dbo.ListPage ON
--po
...
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol
)values (17, 'Normal List','dbo.mrv_bill_list','JRV\NormalListView.xml',41,null,null)
END

update dbo.listpage set SpName='dbo.mrv_bill_list' where id=17

update dbo.listpage set SpName='dbo.mrv_bill_detail_list' where id=83
...
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol
)values (83, 'Detail List','dbo.mrv_bill_detail_list','JRV\DetailView.xml',41,null,null)
END
...
--Stock Journal
if NOT exists (select 1 from ListPage em where em.Id=188)
BEGIN
INSERT INTO dbo.ListPage
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol
)values (188, 'Normal','dbo.SJList','SJ\NormalList.xml',52,null,null)
END

if NOT exists (select 1 from ListPage em where em.Id=189)
BEGIN
INSERT INTO dbo.ListPage
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol
)values (189, 'Detail List','dbo.SJDetailList','SJ\DetailView.xml',52,null,null)
END

if NOT exists (select 1 from ListPage em where em.Id=190)
BEGIN
INSERT INTO dbo.ListPage
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol
...
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol
)values (196, 'Normal List','dbo.ChallanList','TakaJR\NormalListView.xml',51,null,null)
END

if NOT exists (select 1 from ListPage em where em.Id=197)
BEGIN
INSERT INTO dbo.ListPage
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol
)values (197, 'Detail List','dbo.ChallanDetailList','TakaJR\DetailView.xml',51,null,null)
END

if NOT exists (select 1 from ListPage em where em.Id=198)
BEGIN
INSERT INTO dbo.ListPage
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol
)values (198, 'Party Wise List','dbo.ChallanSummaryList','TakaJR\PartyWiseView.xml',51,'ac.AccName',null)
END

if NOT exists (select 1 from ListPage em where em.Id=199)
BEGIN
INSERT INTO dbo.ListPage
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol
)values (199, 'Product Wise List','dbo.ChallaSummaryList','TakaJR\ProductSummaryView.xml',51,'pd.ProductName',null)
END

 if NOT exists (select 1 from ListPage em where em.Id=200)
BEGIN
INSERT INTO dbo.ListPage
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol,Extra1
...
if NOT exists (select 1 from ListPage em where em.Id=220)
BEGIN
INSERT INTO dbo.ListPage
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol
)values (220, 'Normal List','dbo.BatchList','yarn\NormalListView.xml',20,null,null)
END

if NOT exists (select 1 from ListPage em where em.Id=221)
BEGIN
INSERT INTO dbo.ListPage
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol
)values (221, 'Detail List','dbo.BatchDetailList','yarn\DetailList.xml',20,null,null)
END


if NOT exists (select 1 from ListPage em where em.Id=222)
BEGIN
INSERT INTO dbo.ListPage
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol,Extra1
)values (222, 'Deleted List','dbo.BatchList','yarn\DeletedView.xml',20,null,null,'Deleted')
END 



--Yarn Production 
if NOT exists (select 1 from ListPage em where em.Id=223)
BEGIN
INSERT INTO dbo.ListPage
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol
)values (223, 'Normal List','dbo.TakaprodList','Yarn\prod_NormalListView.xml',21,null,null)
END
 
if NOT exists (select 1 from ListPage em where em.Id=224)
BEGIN
INSERT INTO dbo.ListPage
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol
)values (224, 'Product Wise Summary','dbo.TakaProdSummaryList','Yarn\prod_ProductSummaryList.xml',21,'pd.ProductName',null)
END

if NOT exists (select 1 from ListPage em where em.Id=225)
BEGIN
INSERT INTO dbo.ListPage
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol,Extra1
)values (225, 'Deleted List','dbo.TakaprodList','Yarn\prod_DeletedView.xml',21,null,null,'Deleted')
END

--Beam Production BeamProdList sp
if NOT exists (select 1 from ListPage em where em.Id=226)
BEGIN
INSERT INTO dbo.ListPage
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol
)values (226, 'Normal List','dbo.BeamProdList','weaving\bpd_NormalListView.xml',11,null,null)
END
 
if NOT exists (select 1 from ListPage em where em.Id=227)
BEGIN
INSERT INTO dbo.ListPage
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol
)values (227, 'Product Wise Summary','dbo.BeamprodSmryList','weaving\bpd_ProductSummaryView.xml',11,null,null)
END

 if NOT exists (select 1 from ListPage em where em.Id=228)
BEGIN
INSERT INTO dbo.ListPage
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol,Extra1
)values (228, 'Deleted List','dbo.BeamProdList','weaving\bpd_DeletedView.xml',11,null,null,'Deleted')
END

-- Purchase Request/Indent

--Indent/Request
if NOT exists (select 1 from ListPage em where em.Id=229)
BEGIN
INSERT INTO dbo.ListPage
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol
)values (229, 'Normal','dbo.ReqList','PO\req_NormalList.xml',2,null,null)
END

if NOT exists (select 1 from ListPage em where em.Id=230)
BEGIN
INSERT INTO dbo.ListPage
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol
)values (230, 'Detail List','dbo.req_det_list','PO\req_DetailView.xml',2,null,null)
END

if NOT exists (select 1 from ListPage em where em.Id=231)
BEGIN
INSERT INTO dbo.ListPage
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol
)values (231, 'Product Wise List','dbo.PoSummaryList','PO\req_ProductSummaryView.xml',2,'pd.ProductName',null)
END

 if NOT exists (select 1 from ListPage em where em.Id=232)
BEGIN
INSERT INTO dbo.ListPage
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol,Extra1
)values (232, 'Deleted List','dbo.ReqList','PO\req_DeletedView.xml',2,null,null,'Deleted')
END



--TakaCutting TakaCuttingList sp
if NOT exists (select 1 from ListPage em where em.Id=233)
BEGIN
INSERT INTO dbo.ListPage
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol
)values (233, 'Normal List','dbo.TakaCuttingList','weaving\tc_normal_listview.xml',43,null,null)
END
 
if NOT exists (select 1 from ListPage em where em.Id=234)
BEGIN
INSERT INTO dbo.ListPage
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol
)values (234, 'Detail List','dbo.TakaCuttingDetailList','weaving\tc_detail_List.xml',43,null,null)
END
...
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol,Extra1
)values (235, 'Deleted List','dbo.TakaCuttingList','weaving\tc_deleted_view.xml',43,null,null,'Deleted')
END
...
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol,Extra1
)values (236, 'Bom List','dbo.bomList','apparel\bom_list.xml',34,null,null,'bom')
END
...
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol
)values (237, 'Normal List','dbo.TakaprodList','weaving\tp_NormalListView.xml',17,null,null)
END
...
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol
)values (238, 'Product Wise Summary','dbo.TakaProdSummaryList','weaving\tp_product_summaryList.xml',17,'pd.ProductName',null)
END
...
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol
)values (239, 'Machine Wise Summary','dbo.TakaProdSummaryList','weaving\tp_mach_summaryList.xml',17,'m.MachineName',null)
END

if NOT exists (select 1 from ListPage em where em.Id=240)
BEGIN
INSERT INTO dbo.ListPage
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol,Extra1
)values (240, 'Deleted List','dbo.TakaprodList','weaving\tp_DeletedView.xml',17,null,null,'Deleted')
END

-- taka cutting folding

if NOT exists (select 1 from ListPage em where em.Id=241)
BEGIN
INSERT INTO dbo.ListPage
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol
)values (241, 'Normal List','dbo.ChallanList','GRN\foldingListView.xml',22,null,null)
END


if NOT exists (select 1 from ListPage em where em.Id=242)
BEGIN
INSERT INTO dbo.ListPage
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol
)values (242, 'Normal','dbo.POList','PO\ge_NormalList.xml',53,null,null)
END


if NOT exists (select 1 from ListPage em where em.Id=243)
BEGIN
INSERT INTO dbo.ListPage
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol,Extra1
)values (243, 'Deleted List','dbo.POList','PO\ge_DeletedView.xml',53,null,null,'Deleted')
END




--weaving job card list
if NOT exists (select 1 from ListPage em where em.Id=244)
BEGIN
INSERT INTO dbo.ListPage
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol
)values (244, 'Job Card List','dbo.jobcardList','weaving\job_card_normal.xml',33,null,null)
END
...
--Stock Transfer
if NOT exists (select 1 from ListPage em where em.Id=245)
BEGIN
INSERT INTO dbo.ListPage
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol
)values (245, 'Normal List','dbo.ChallanList','SC\st_NormalListView.xml',57,null,null)
END

if NOT exists (select 1 from ListPage em where em.Id=246)
BEGIN
INSERT INTO dbo.ListPage
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol
)values (246, 'Detail List','dbo.ChallanDetailList','SC\st_DetailView.xml',57,null,null)
END


if NOT exists (select 1 from ListPage em where em.Id=247)
BEGIN
INSERT INTO dbo.ListPage
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol
)values (247, 'Product Wise List','dbo.ChallanSummaryList','SC\st_ProductSummaryView.xml',57,'pd.ProductName',null)
END

 if NOT exists (select 1 from ListPage em where em.Id=248)
BEGIN
INSERT INTO dbo.ListPage
(
   Id, Descr,SpName,LayoutFile,VTypeId,GroupCol,SumCol,Extra1
)values (248, 'Deleted List','dbo.ChallanList','SC\st_DeletedView.xml',57,null,null,'Deleted')
END
