...
{
    public partial class MrvIndex : KontoMetroForm
    {
        ...
        private void OpenItemLookup(int _selvalue, MrvTransDto er)
        {
            ...
            frm.PTypeId = 0;
            frm.VoucherType = VoucherTypeEnum.MillReceipt;
        ...
        private bool ValidateData()
        {
            ...
            if (!MillRecPara.Challan_Required && string.IsNullOrEmpty(invTypeLookUpEdit.Text))
            {
            ...
            else if (!MillRecPara.Challan_Required && Convert.ToInt32(tdsAccLookup.SelectedValue) == 0 && tdsAmtTextEdit.Value != 0)
            {
        ...
        private void GridControl1_ProcessGridKey(object sender, KeyEventArgs e)
        {
            ...
            {
                Log.Error(ex, "Mill Receipt GridControl KeyDown");
        ...
        private void TabControlAdv1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (tabControlAdv1.SelectedIndex == 1)
            {
                ...
                {
                    var _list = tabPageAdv2.Controls[0] as MrvListView;
                    _list.ActiveControl = _list.KontoGrid;
                    this.Text = "Mill Receipt [View]";
                    return;
                }
                var _ListView = new MrvListView();
        ...
        private void OkSimpleButton_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                Log.Error(ex, "Mill Receipt Save");
        ...
        public override void Print()
        {
            ...
            try
            {
                ...
                rpt.Load(new FileInfo("reg\\doc\\MRBarcode.rdlx"));
        ...
        public override void SaveDataAsync(bool newmode)
        {
                ...
                using (var _tran = db.Database.BeginTransaction())
                {
                    try
                    {
                        ...
                        foreach (var item in DelTrans)
                        {
                            ...
                            {
                                item1.IsDeleted = true;
                                var pd1 = db.Prods.FirstOrDefault(x => x.IssueRefId == item1.Id);
                        ...
                        foreach (var p in DelProd)
                        {
                            ...
                            if (prd != null)
                            {
                               ...
                               //find for receive Fresh Taka Entry
                               
                                var pd1 = db.Prods.FirstOrDefault(x => x.IssueRefId == prd.Id);
                        ...
                        {
                            string TableName = "Mill Receipt Voucher";
            ...
            if (IsSaved)
            {
               // NewRec();
                ...
                {
                    if (MillRecPara.Generate_Barcode && MessageBox.Show("Print Barcode ?", "Print", MessageBoxButtons.YesNo) == DialogResult.Yes)
                    {
        ...
        private bool UpdateChallan(KontoContext db,ChallanModel model)
        {
            ...
            model.TypeId = (int)VoucherTypeEnum.MillReceipt;
        ...
        private bool UpdateBill(KontoContext db,ChallanModel model)
        {
            ...
            billModel.TypeId = (int)VoucherTypeEnum.MillReceiptVoucher;
