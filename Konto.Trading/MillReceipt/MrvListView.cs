...
{
    public partial class MrvListView : ListBaseView
    {
            ...
            try
            {
                ...
                using (var con = new SqlConnection(db.Database.Connection.ConnectionString))
                {
                    ...
                    using (var cmd = new SqlCommand(listDateRange1.SelectedItem.SpName, con))
                    {
                        ...
                        if(!MillRecPara.Challan_Required)
                            cmd.Parameters.Add("@VTypeId", SqlDbType.Int).Value = (int)VoucherTypeEnum.MillReceiptVoucher;
                        else
                            cmd.Parameters.Add("@VTypeId", SqlDbType.Int).Value = (int)VoucherTypeEnum.MillReceipt;
