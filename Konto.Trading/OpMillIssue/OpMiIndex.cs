...
{
    public partial class OpMiIndex : KontoMetroForm
    {
        ...
        public OpMiIndex()
        {
            ...
            this.MainLayoutFile = KontoFileLayout.Op_Mill_Stock_Index;
            this.GridLayoutFile = KontoFileLayout.Op_Mill_Stock_Trans;
        ...
        private void OpenItemLookup(int _selvalue, GrnTransDto er)
        {
            ...
            frm.VoucherType = VoucherTypeEnum.OpMillIssue;
        ...
        private void LoadData(GrnDto model)
        {
            ...
            this.Text = "Op Mill Stock [View/Modify]";
        ...
        private void TabControlAdv1_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (tabControlAdv1.SelectedIndex == 0)
            {
                ...
                this.Text = "Op Mill Stock [View]";
                else
                    this.Text = "Op Mill Stock [Add]";
                return;
            }
            if (tabPageAdv2.Controls.Count > 0)
            {
                var _list = tabPageAdv2.Controls[0] as OpMiListView;
                _list.ActiveControl = _list.KontoGrid;
                return;
            }
            if (tabControlAdv1.SelectedIndex == 1)
            {
                var _ListView = new OpMiListView();
        ...
        private void OkSimpleButton_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                Log.Error(ex, "Op Mill Stock Save");
        ...
        public override void NewRec()
        {
            ...
            this.Text = "Op Mill Issue [Add New]";
        ...
        public override void SaveDataAsync(bool newmode)
        {
            ...
            model.TypeId = (int)VoucherTypeEnum.OpMillIssue;
            ...
            using (var db = new KontoContext())
            {
                using (var _tran = db.Database.BeginTransaction())
                {
                    try
                    {
                        ...
                        _find.ChallanType = (int)ChallanTypeEnum.MILL_ISSUE;
                        if (this.PrimaryKey == 0)
                        {
                            ...
                            //_find.VoucherNo = _f
                            _find.TypeId = (int)VoucherTypeEnum.OpMillIssue;
                        ...
                        foreach (var item in _translist)
                        {
                            ...
                            foreach (var p in prlist)
                            {
                                ...
                                map.Map(p, prodModel);
                                if(prodModel.CProductId== null)
                                    prodModel.CProductId = item.ProductId;
                                if (p.Id <= 0)
                                {
                                ...
                                ProdOutModel pOut = db.ProdOuts.FirstOrDefault(k => k.ProdId == prodModel.Id);
                                if (pOut == null)
                                {
