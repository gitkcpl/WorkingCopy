...
{
    public partial class PendingGreyForMillView : KontoForm
    {
        TextEdit headerEdit = new TextEdit();
        GridColumn activeCol = null;
        public List<DetailStockDto> list = new List<DetailStockDto>();
        public string IssueType = "Stock";
        public decimal _LotMeters;
        public int ProductId { get; set; }
        public PendingGreyForMillView()
        {
            InitializeComponent();
            headerEdit.Hide();
