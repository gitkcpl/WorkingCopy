...
{
    public partial class OJCListView : ListBaseView
    {
...

        {
            InitializeComponent();
                ...
                this.listDateRange1.VoucherType = VoucherTypeEnum.OutJobChallan;
            ...
            try
            {
                ...
                using (var con = new SqlConnection(db.Database.Connection.ConnectionString))
                {
                    ...
                    using (var cmd = new SqlCommand(listDateRange1.SelectedItem.SpName, con))
                    {
                        ...
                        cmd.Parameters.Add("@VTypeId", SqlDbType.Int).Value = (int)VoucherTypeEnum.OutJobChallan;
        ...
        public override void DeleteRec()
        {
            ...
            catch (Exception ex)
            {
                ...
                Log.Error(ex, "Mill Receipt delete");
        ...
        public override void Print()
        {
            ...
            if (KontoView.Columns.ColumnByFieldName("Id") != null)
            {
                ...
                var frm = new DocPrintParaView(VoucherTypeEnum.OutJobChallan, "Job Sales Challan", id, id, "JSC", "ChallanId");
